...
typedef void (^UploadOneFileSucceededBlock)(NSURLResponse *operation, NSInteger index, NSString *key);
typedef void (^UploadOneFileFailedBlock)(NSURLResponse *operation, NSInteger index, NSDictionary *error);
typedef void (^UploadOneFileProgressBlock)(NSURLResponse *operation, NSInteger index, double percent);
