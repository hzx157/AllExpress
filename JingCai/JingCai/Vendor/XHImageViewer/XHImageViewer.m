...
- (void)prepareToDismiss {
    ...
    if (self.willDismissWithSelectedViewBlock) {
        self.willDismissWithSelectedViewBlock(self, currentView,self.pageIndex);
    }
...
//                                 }
                             ...
                             if (self.didDismissWithSelectedViewBlock) {
                                 self.didDismissWithSelectedViewBlock(self, currentView,self.pageIndex);
                             }
                         }
                     }];
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.didChangeToImageViewBlock) {
        self.didChangeToImageViewBlock(self, [self currentView],self.pageIndex);
    }
}
