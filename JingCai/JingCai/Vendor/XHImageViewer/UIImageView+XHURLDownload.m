...
#pragma mark - SDWebImage 下载图片 平滑过度
- (void)xgx_setImageWithUrlString:(NSString *)urlString placeholderImage:(UIImage *)placeHolderImage{
    
    [self xgx_setImageWithUrlString:urlString placeholderImage:placeHolderImage completed:nil];
    
    
}
- (void)xgx_setImageWithUrlString:(NSString *)urlString placeholderImage:(UIImage *)placeHolderImage completed:(XGXWebImageCompletionWithFinishedBlock)completedBlock{
