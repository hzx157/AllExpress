                 ...
                 minimumFontSize:(int)minFontSize
{
  ...
  CGSize tempSize =  [[self text] boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:self.font} context:nil].size;
...
//  CGSize unconstrainedSize = CGSizeMake(tempSize.width, MAXFLOAT);
  ...
  do {
    ...
    calculatedSizeWithCurrentFontSize = [[self text] boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:self.font} context:nil].size;
